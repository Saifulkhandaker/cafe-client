    ...
    return (
        <div className="bg-[#101010] py-20 lg:py-32">
            <div className="text-white text-center  space-y-3">
                <h2 className="text-2xl text-[#C8A077] font-bold" data-aos="fade-down" data-aos-duration="2000">Why Choose Us</h2>
                <h1 className="text-3xl md:text-5xl font-extrabold" data-aos="fade-down" data-aos-duration="2000">Welcome to Our <br /> Coffehouse</h1>
                <p className="text-sm md:text-lg" data-aos="fade-up" data-aos-duration="2000">Our mission since we roasted our first batch of coffee in 1987 is to commitment <br /> giving you the BEST cup of coffee you have ever had.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-[90%] mx-auto mt-10 lg:mt-20">
                <div className=" text-center flex flex-col items-center space-y-3 text-white bg-[#1C1C1C] py-16 px-3" data-aos="flip-down" data-aos-duration="2000">
            ...
            <div className="lg:flex lg:gap-16 justify-between w-[90%] mx-auto mt-14 lg:mt-20 ">
                {/* text part */}
                <div className="lg:w-[30%] lg:flex flex-col lg:justify-center text-white space-y-6" data-aos="zoom-in-up" data-aos-duration="2000">
                ...
                {/* img part */}
                <div className="flex flex-row items-center  gap-2 md:gap-3 mt-5 lg:mt-0" data-aos="zoom-in-up" data-aos-duration="2000"> 
